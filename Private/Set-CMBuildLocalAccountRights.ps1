function Set-CMBuildLocalAccountRights {
	<#
	.SYNOPSIS
	...
	.EXAMPLE
	Set-CMBuildLocalAccountRights -UserName "sccmadmin" -Privileges 'SeServiceLogonRight'
	...
	Write-Log -Category "info" -Message "Set-CMBuildLocalAccountRights: $UserName"
