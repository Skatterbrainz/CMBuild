function Invoke-CMBuildRestart {
    <#
    .SYNOPSIS
    Configure a Restart with Post-Start Resume
    .DESCRIPTION
    Configures scripts and a scheduled task to resume CMBuild after a restart.  Then invokes a restart.
    .PARAMETER XmlFile
    Name of XML template file
    .EXAMPLE
    Invoke-CMBuildRestart -XmlFile .\cmbuild.xml
    .NOTES
    #>
    param (
